...
include_once('Caldav2ics_InstallIndicator.php');

class Caldav2ics_LifeCycle extends Caldav2ics_InstallIndicator {
    ...
    public function addSettingsSubMenuPage() {
        //$this->addSettingsSubMenuPageToPluginsMenu();	// Default, under Plugins
        $this->addSettingsSubMenuPageToSettingsMenu();	// changed to SettingsMenu 12.10.18
    }
