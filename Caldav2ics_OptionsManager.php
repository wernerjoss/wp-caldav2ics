...
class Caldav2ics_OptionsManager {
	...
	*/
	protected function getOptionValueI18nString($optionValue) {
		switch ($optionValue) {
			case 'true':
			return __('true', 'wp-caldav2ics');
			case 'false':
			return __('false', 'wp-caldav2ics');

			case 'Administrator':
			return __('Administrator', 'wp-caldav2ics');
			case 'Editor':
			return __('Editor', 'wp-caldav2ics');
			case 'Author':
			return __('Author', 'wp-caldav2ics');
			case 'Contributor':
			return __('Contributor', 'wp-caldav2ics');
			case 'Subscriber':
			return __('Subscriber', 'wp-caldav2ics');
			case 'Anyone':
			return __('Anyone', 'wp-caldav2ics');
		}
		return $optionValue;
	}
